...
WGS84Util.destinationPoint = function(coordA, brng, dist) {
  ...
  return {
    "type": "Point",
    "coordinates": [parseFloat(this.radToDeg(lat2).toFixed(10)), parseFloat(this.radToDeg(lon2).toFixed(10))]
  };
};
...
WGS84Util.UTMtoLL = function(utm) {
    ...
    if (utm.accuracy) {
        ...
        result.coordinates[0] = parseFloat(lat.toFixed(8));
        result.coordinates[1] = parseFloat(lon.toFixed(8));
    }
